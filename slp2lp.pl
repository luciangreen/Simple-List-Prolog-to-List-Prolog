...
?- [[[n,f1],[[v,a],[v,b],[v,c],[v,d],[v,e]],":-",[[[n,+],[[v,a],[v,b],[v,f]]],[[n,+],[[v,c],[v,f],[v,g]]],[[n,+],[[v,d],[v,g],[v,h]]],[[n,=],[[v,h],[v,e]]]]]]
...
slp2lp_variables(Name1,[v,Name1]) :- !.
...
process_body2(Body1,Body2%%,Body3
	...
	append_list2([[Body3,Body4],Body5],Body2),
	!.
...
process_body2(Body1,Body2) :-
        ...
        process_body2(Statements2,Body4),
		  append_list2([[[n,not],[Body3]],Body4
        ],Body2),
...
process_body2(Body1,Body2) :-
        ...
        append_list2([[[n,"->"],[Body3,Body4,Body5
        ]],Body6],Body2),
...
process_body2(Body1,Body2) :-
	...
	predicate_or_rule_name(Statement),
